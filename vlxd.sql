...
INSERT INTO `chitiethoadon` VALUES (1,2,1188,10,5,10260),(2,3,93170,20,1,1677060),(4008,9,390500,15,0,5857500),(4005,10,380600,100,0,34600000),(4006,12,214500,10,0,1950000),(4007,9,390500,25,5,9274375);
...
INSERT INTO `hoadon` VALUES (1,'2018-09-20 00:00:00','2018-09-25 00:00:00',5,1),(2,'2018-09-10 00:00:00','2018-09-28 00:00:00',1,1),(4005,'2018-10-05 00:00:00','2018-10-07 00:00:00',10,1),(4006,'2018-10-05 00:00:00','2018-10-06 00:00:00',6,1),(4007,'2018-10-21 00:00:00','2018-10-23 00:00:00',7,1),(4008,'2018-10-21 00:00:00','2018-10-22 00:00:00',8,1);
...
INSERT INTO `khachhang` VALUES (1,'Nguyễn Thị Ánh','Hằng','Nữ',NULL,'120 Ha Ton Quyen','901298357'),(2,'Trần Minh','Hằng','Nữ',NULL,'87 Trần Hưng Đạo','937948170'),(3,'Lê Thị','Hồng','Nữ',NULL,'24 Ky Con','989571892'),(4,'Nguyễn Văn','Tài','Nam',NULL,'8 Pham Van Hai','1876349701'),(5,'Nguyễn Phú','Cường','Nam',NULL,'6 Ky Hoa','983274831'),(6,'Lê Thị Hoàng','Dung','Nữ',NULL,'90 An Duong Vuong','1213879818'),(7,'Trần Hoàng Thái','Phong','Nam',NULL,'10 Tan Da','990471908'),(8,'Bùi Ngọc Minh','Anh','Nữ',NULL,'2817 Minh Phung','1238764792'),(9,'Trần Thanh','Tùng','Nam',NULL,'187 Lao Tu','989717298'),(10,'Hồ Vĩnh','Lợi','Nam',NULL,'45 Sư Vạn Hạnh','902535533'),(11,'Huỳnh','Minh Huy','Nam',NULL,'47/3 Ho Hao Hon','523647895');
...
INSERT INTO `nhanvien` VALUES (1,'Ma Hoàng Hải','Nguyên',NULL,NULL,NULL,NULL);
...
CREATE TABLE `sanpham` (
  ...
  `DonGia` decimal(65,0) DEFAULT NULL,
...
INSERT INTO `taikhoankh` VALUES (1,'nguyenthianhhang','anhhangtkNu',1),(2,'tranminhhhang','minhhangtkNu',2),(3,'lethihong','thihongtkNu',3),(4,'nguyenvantai','vantaitkNam',4),(5,'nguyenphucuong','phucuongtkNam',5);
...
INSERT INTO `taikhoannv` VALUES (1,'mahoanhainguyen','123456789',1);
...
-- Dump completed on 2021-04-01 12:54:53
